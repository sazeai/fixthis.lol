-- Billing schema, extracted from the original migrations so it can be
-- reapplied without unpicking migrations 15-17.
-- Sources: 00000000000001_fixthis.sql, 00000000000012_settled_bid_floor.sql
...
-- bid_quotes.event_text (migration 10)
...
-- Final settlement functions (migration 12).
-- NOTE: these reference the placements table and its bid columns, which
-- migrations 15-16 removed. Rewriting them against offers is the real work
-- of turning this back on; the payment plumbing around them is intact.
