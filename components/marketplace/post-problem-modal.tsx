...
export function PostProblemModal({
  ...
  const triggerClass = asLink
    ...
    : compact
      ? "group inline-flex h-8 items-center gap-1.5 whitespace-nowrap rounded-full bg-[#111] px-3.5 text-[10px] font-bold uppercase tracking-[0.06em] text-white transition-colors duration-200 ease-out hover:bg-[#ef4e37] active:scale-[0.97]"
